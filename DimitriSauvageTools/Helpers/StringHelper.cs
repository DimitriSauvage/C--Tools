...
namespace DimitriSauvageTools.Helpers
{
    public static class StringHelper
    {
        ...
        /// <summary>
        /// Supprime tous les espaces d'une chaine de caractères
        /// </summary>
        /// <param name="input">Chaine ou remplacer les espaces</param>
        /// <returns></returns>
        ...
        /// <param name="isWhiteSpacesSensitive"></param>
        /// <param name="isDiacriticsSensitive"></param>
        /// <returns></returns>
        public static string Format(this string input, bool isCaseSensitive, bool isWhiteSpacesSensitive, bool isDiacriticsSensitive)
        {
            string result = input;
            if (!isCaseSensitive) result = result.ToLower();
            if (!isWhiteSpacesSensitive) result = result.Replace(" ", string.Empty);
            if (!isDiacriticsSensitive) result = result.RemoveDiacritics();
