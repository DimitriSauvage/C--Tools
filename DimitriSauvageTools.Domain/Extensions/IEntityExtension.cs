...
namespace DimitriSauvageTools.Domain.Extensions
{
    public static class IEntityExtension
    {
        ...
        /// </summary>
        private static Dictionary<string, Tuple<dynamic, dynamic>> ValuesChanged { get; set; } = new Dictionary<string, Tuple<dynamic, dynamic>>();
        #endregion
